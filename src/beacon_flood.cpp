...
void beaconFlood() {
  // Fork from https://github.com/74lg0/ESP32-Deauther
  // Source code from https://github.com/Tnze/esp32_beaconSpam
  // Implementation with https://github.com/74lg0
  // ===== Settings ===== //
  const uint8_t channels[] = {1,6,13}; // used Wi-Fi channels (available: 1-14)
  ...
  const uint32_t pkgsPerSSID = 3;
  const uint32_t delayMillis = 1;
  const uint32_t pkgsRateMs = 50;
